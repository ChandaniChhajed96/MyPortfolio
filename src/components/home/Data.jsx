...
const Data = () => {
  return (
    <div className="home__data">
        ...
        <p className="home__description">I am an experienced Software Engineer skilled in Angular, React, .NET Core, C# and SQL database, dedicated to delivering quality solutions.</p>
