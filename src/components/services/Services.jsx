         ...
         <div className="services__container container grid">
            ...
            <div className={toggleState === 3 ? "services__modal active-modal" : "services__modal"}>
                <div className="services__modal-content">
                    ...
                    <p className="services__modal-description">Ensuring the effective and efficient operation of web applications by managing server-side logic, databases, and application functionality.</p>
                    ...
                    <ul className="services__modal-services grid">
                        ...
                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">Security and Compliance</p>
                        </li>

                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">Error Handling and Logging</p>
                        </li>
                        ...
                        <li className="services__modal-service">
                            <i className="uil uil-check-circle services__modal-icon"></i>
                            <p className="services__modal-info">Scalability and Reliability</p>
                        </li>
                    </ul>
                </div>
            </div>
